...
def main():
 db=json.loads(DATA_PATH.read_text()); sources=json.loads(SOURCES_PATH.read_text()); existing_urls={c.get('source'):c for c in db['candidates'] if c.get('source')}; discovered=[]
